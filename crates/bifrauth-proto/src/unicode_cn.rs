// @generated by tools/unicode/gen_cn_table.py — DO NOT EDIT.
// Source: https://www.unicode.org/Public/16.0.0/ucd/extracted/DerivedGeneralCategory.txt
...
mod tests {
    ...
    #[test]
    fn known_reserved_and_noncharacters_are_cn() {
        assert!(is_cn(0x0378)); // reserved
